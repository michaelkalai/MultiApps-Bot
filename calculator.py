...
class Calculator(discord.ui.View):
    ...
    if self.selected == "π":
      if self.operation == "" and "π" not in self.value1 and self.value1[-1] != ".":
        if self.value1 != "0":
          ...
          self.value1 = self.selected
      elif self.operation != "" and self.value2 == "":
        self.value2 = "π"
  ...
  @discord.ui.button(label = "Cos", row = 2, style = discord.ButtonStyle.red)
  async def cos(self, interaction: discord.Interaction, button: discord.ui.Button):
    if self.operation == "" and self.value2 == "":
      self.answer = round(math.cos(self.pi_con(self.value1)), 10)
      if float(self.answer) == int(self.answer):
        self.answer = int(self.answer)
      self.answer = str(self.answer)
      self.value1 = self.answer
  ...
  @discord.ui.button(label = "Tan", row = 3, style = discord.ButtonStyle.red)
  async def tan(self, interaction: discord.Interaction, button: discord.ui.Button):
    if self.operation == "" and self.value2 == "":
      self.answer = round(math.tan(self.pi_con(self.value1)), 10)
      if float(self.answer) == int(self.answer):
        self.answer = int(self.answer)
      self.answer = str(self.answer)
      self.value1 = self.answer
  ...
  @discord.ui.button(label = "π", row = 4, style = discord.ButtonStyle.red)
  ...
  @discord.ui.button(label = "^/√", row = 0, style = discord.ButtonStyle.blurple)
  async def ex_root(self, interaction: discord.Interaction, button: discord.ui.Button):
    self.operation = "^" if self.operation == "" or self.operation == "√" else "√"
    embed = self.emb()
    await interaction.response.edit_message(embed=embed)
    ...
    try:
      if self.operation != "":
        ...
        if self.operation == "+":
          ...
          self.answer = value2 ** (1/value1)
      else:
        self.answer = self.value1
      if float(self.answer) == int(self.answer):
        self.answer = int(self.answer)
      self.answer = str(self.answer)
      self.value1 = self.answer
